...
.home-hero {
  ...
  background:
    linear-gradient(
      120deg,
      rgb(245 248 252 / 94%) 0%,
      rgb(255 255 255 / 90%) 48%,
      rgb(237 244 240 / 92%) 100%
    ),
    var(--content-surface);
  border: 1px solid rgb(24 38 57 / 8%);
...
.hero-metric {
  ...
  border: 1px solid rgb(100 116 139 / 12%);
  border-radius: 8px;
}
