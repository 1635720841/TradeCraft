  ...
  >
    ...
    >
      ...
      <el-alert
        ...
        title="此处仅完成租户开户与首位登录账号；成员增删、角色与权限请在租户企业内的「企业管理 → 成员与权限」维护。"

      />



      <div class="mb-3 text-sm font-medium mw-text-body">租户信息</div>
      ...
      <div class="mb-3 text-sm font-medium mw-text-body">开户账号</div>

      <el-form-item label="登录邮箱" prop="adminEmail">

        <el-input

          v-model="createForm.adminEmail"

          placeholder="首位企业管理员登录邮箱"
      ...
      <el-form-item label="联系人姓名">
        ...
        <el-input v-model="createForm.adminName" maxlength="64" placeholder="选填，默认同邮箱前缀" />
...
const createRules: FormRules = {
  ...
  adminEmail: [{ required: true, message: "请输入开户邮箱", trigger: "blur" }],
...
async function submitCreate() {
  ...
  await createFormRef.value.validate(async (valid) => {
    ...
    try {
      ...
      message("租户已开户，首位账号可登录企业管理", { type: "success" });
